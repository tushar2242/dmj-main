...
export default class JwelleryDetails extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            setAsk: false,
    ...
    render() {
        const { setAsk, setWrt } = this.state;
        return (
            <>
                <HeaderCon />
                <Navbar />
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-5 mt-4">
                            ...
                            <div className="review-top">
                                ...
                                <i className="bi bi-star-half icon-text text-warning"></i> <span className="text-muted ms-2 text-size">50 Reviews</span>
                            </div>
